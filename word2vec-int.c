...
void InitNet() {
  ...
  for (a = 0; a < vocab_size; a++) for (b = 0; b < layer1_size; b++) {
    next_random = next_random * 69069 + 1;
...
void *TrainModelThread(void *id) {
  int local_iter = iter, c, d, word, last_word, sen[MAX_SENTENCE_LENGTH + 1],
    target, label;
  long long l1, l2, a, b, cw, sentence_length = 0, sentence_position = 0;
  long long word_count = 0, last_word_count = 0;
  unsigned int next_random = (unsigned int)(long long)id;
  char eof = 0;
  real f, g;
  clock_t now;
