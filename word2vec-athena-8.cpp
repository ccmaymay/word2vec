...
void TrainModel(real* expTable, shared_ptr<NaiveLanguageModel> language_model, real alpha, long long embedding_size, int window) {
  ...
  auto neg_sampling_strategy(make_shared<DiscreteSamplingStrategy<NaiveLanguageModel> >(
...
int main(int argc, char **argv) {
  ...
  TrainModel(expTable, language_model, alpha, embedding_size, window);
  free(expTable);
  return 0;
}
